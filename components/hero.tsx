...
export default function Hero() {
  return (
    // <section className="relative bg-gradient-to-br from-primary via-primary to-primary/90 text-primary-foreground py-20 md:py-32 overflow-hidden">
      <section
          className="relative text-primary-foreground py-20 md:py-32 overflow-hidden"
          style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="inline-block bg-secondary/20 text-secondary px-4 py-2 rounded-full text-xl font-semibold">
              ✨ Brand Overview
            </div>
            <h1 className="text-5xl md:text-7xl font-bold leading-tight text-balance font text-primary">
              GT Consult is a{"  "}
